...
import org.eshark.dctm.gui.ConnectedUserView;
 ...
 * </TR>
 * <TR>
 * <TD>File Name</TD><TD>::</TD><TD>ShowConnectedUserActionTask.java</TD>
 * </TR>
 * <TR>
 * <TD>Created on</TD><TD>::</TD><TD>Sep 22, 2008 11:39:35 AM</TD>
 * </TR>
 * <TR>
 ...
 * </TABLE>
 */
public class ShowConnectedUserActionTask extends org.jdesktop.application.Task<String, Void>
{
	public ShowConnectedUserActionTask(org.jdesktop.application.Application aApplication)
	{
		super(aApplication);
	}
	...
	protected String doInBackground() throws Exception
	{
		...
		if (CONN_USER_VIEW == null)
		{
			CONN_USER_VIEW = new ConnectedUserView();
			desktop.add(CONN_USER_VIEW);
			CONN_USER_VIEW.pack();
			CONN_USER_VIEW.show();
			CONN_USER_VIEW.setSelected(true);
			CONN_USER_VIEW.validate();
		}

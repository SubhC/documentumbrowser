...
import static org.eshark.dctm.gui.MainMDIView.CNT_SYSOBJ_VIEW;
 ...
 * </TR>
 * <TR>
 * <TD>File Name</TD><TD>::</TD><TD>CountSysObjectView.java</TD>
 * </TR>
 * <TR>
 * <TD>Created on</TD><TD>::</TD><TD>Sep 22, 2008 11:33:30 AM</TD>
 * </TR>
 * <TR>
...
public class CountSysObjectView extends javax.swing.JInternalFrame
{
	private static final long	serialVersionUID	= 7364752984101079066L;

	/** Creates new form ConnectedUserView */
	public CountSysObjectView()
	{
		try
		{
	...
	private void initComponents()
	{
		...
		javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(
				org.eshark.dctm.MainApplication.class).getContext().getActionMap(CountSysObjectView.class, this);
		exportButton.setAction(actionMap.get("exportTable")); // NOI18N
		exportButton.setMnemonic('E');
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(
				org.eshark.dctm.MainApplication.class).getContext().getResourceMap(CountSysObjectView.class);
	...
	private String					mMapKey	= "count.sysobjects";
}

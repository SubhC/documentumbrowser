...
import org.eshark.dctm.gui.TypeTreeView;
 ...
 * </TR>
 * <TR>
 * <TD>File Name</TD><TD>::</TD><TD>ShowTypeTreeActionTask.java</TD>
 * </TR>
 * <TR>
 * <TD>Created on</TD><TD>::</TD><TD>Sep 22, 2008 11:50:04 AM</TD>
 * </TR>
 * <TR>
 ...
 * </TABLE>
 */
public class ShowTypeTreeActionTask extends org.jdesktop.application.Task<String, Void>
{
	public ShowTypeTreeActionTask(org.jdesktop.application.Application aApplication)
	{
		super(aApplication);
	}
	...
	protected String doInBackground() throws Exception
	{
		...
		if (TYPE_TREE_VIEW == null)
		{
			TYPE_TREE_VIEW = new TypeTreeView();
			desktop.add(TYPE_TREE_VIEW);
			TYPE_TREE_VIEW.pack();
			TYPE_TREE_VIEW.show();
			TYPE_TREE_VIEW.setMaximum(true);
			TYPE_TREE_VIEW.setSelected(true);
			TYPE_TREE_VIEW.validate();
		}

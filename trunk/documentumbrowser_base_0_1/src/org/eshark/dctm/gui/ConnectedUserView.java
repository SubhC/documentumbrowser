 ...
 * </TR>
 * <TR>
 * <TD>File Name</TD><TD>::</TD><TD>ConnectedUserView.java</TD>
 * </TR>
 * <TR>
 * <TD>Created on</TD><TD>::</TD><TD>Sep 22, 2008 11:33:16 AM</TD>
 * </TR>
 * <TR>
...
public class ConnectedUserView extends javax.swing.JInternalFrame 
{
	 ...
	 * hold
	 */
	private static final long	serialVersionUID	= -7005318744849719727L;
	/** Creates new form ConnectedUserView */
    public ConnectedUserView() 
    {
        try {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.eshark.dctm.MainApplication.class).getContext().getResourceMap(ConnectedUserView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(org.eshark.dctm.MainApplication.class).getContext().getActionMap(ConnectedUserView.class, this);
    ...
    private String mMapKey = "connected.users";
}

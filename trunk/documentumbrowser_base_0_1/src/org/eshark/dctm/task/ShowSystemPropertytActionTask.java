...
import org.eshark.dctm.gui.SystemPropertyView;
 ...
 * </TR>
 * <TR>
 * <TD>File Name</TD><TD>::</TD><TD>ShowSystemPropertytActionTask.java</TD>
 * </TR>
 * <TR>
 * <TD>Created on</TD><TD>::</TD><TD>Sep 22, 2008 11:49:48 AM</TD>
 * </TR>
 * <TR>
 ...
 * </TABLE>
 */
public class ShowSystemPropertytActionTask extends org.jdesktop.application.Task<String, Void>
{
	public ShowSystemPropertytActionTask(org.jdesktop.application.Application aApplication)
	{
		super(aApplication);
	}
	...
	protected String doInBackground() throws Exception
	{
		...
		if (SYS_PROP_VIEW == null)
		{
			SYS_PROP_VIEW = new SystemPropertyView();
			desktop.add(SYS_PROP_VIEW);
			SYS_PROP_VIEW.pack();
			SYS_PROP_VIEW.show();
			SYS_PROP_VIEW.setSelected(true);
			SYS_PROP_VIEW.validate();
		}

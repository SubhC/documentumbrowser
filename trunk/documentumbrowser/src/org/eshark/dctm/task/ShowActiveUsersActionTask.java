...
import org.eshark.dctm.gui.ActiveUserView;
 ...
 * </TR>
 * <TR>
 * <TD>File Name</TD><TD>::</TD><TD>ShowActiveUsersActionTask.java</TD>
 * </TR>
 * <TR>
 * <TD>Created on</TD><TD>::</TD><TD>Sep 22, 2008 11:39:14 AM</TD>
 * </TR>
 * <TR>
 ...
 * </TABLE>
 */
public class ShowActiveUsersActionTask extends org.jdesktop.application.Task<String, Void>
{
	public ShowActiveUsersActionTask(org.jdesktop.application.Application aApplication)
	{
		super(aApplication);
	}
	...
	protected String doInBackground() throws Exception
	{
		...
		if (ACT_USER_VIEW == null)
		{
			ACT_USER_VIEW = new ActiveUserView();
			desktop.add(ACT_USER_VIEW);
			ACT_USER_VIEW.pack();
			ACT_USER_VIEW.show();
			ACT_USER_VIEW.setSelected(true);
			ACT_USER_VIEW.validate();
		}
